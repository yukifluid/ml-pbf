    ...
    def process(self) -> None:
        ...
        for scene_dir in self.raw_paths:
            ...
            for df in reader:
                ...
                data = torch_geometric.data.Data(V=vertex_features, E=edge_features, N=edge_index, y=dp, vol=vol, mid_pos=mid_pos, mid_vel=mid_vel, num_boundary_particles=config.num_boundary_particles)
